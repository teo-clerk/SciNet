...
const NODES: GraphNode[] = [
  { id: 1, title: 'Exoplanet Transit Spectroscopy', year: 2020, cluster: 0, tags: [0], provisional: false, drift: 0 },
  { id: 2, title: 'Galaxy Formation Simulations', year: 2021, cluster: 0, tags: [0, 1], provisional: false, drift: 0 },
  { id: 3, title: 'Robotic Grasp Planning', year: 2022, cluster: 1, tags: [1], provisional: true, drift: 2 },
  { id: 4, title: null, year: null, cluster: null, tags: [], provisional: false, drift: 0 },
]
